...
export class Vehicle {
	...
	constructor() {
		...
		this.respawn = { x: 3.5, y: 0.5, z: 5, angle: 0 };

	}

	reset( x, z, angle ) {

		this.respawn = { x, y: 0.5, z, angle };

		if ( this.rigidBody ) {

			rigidBody.setPosition( this.physicsWorld, this.rigidBody, [ x, 0.5, z ], false );
	...
	update( dt, controlsInput ) {
		...
		if ( this.spherePos.y < - 10 ) {
			...
			this.reset( this.respawn.x, this.respawn.z, this.respawn.angle );
