const STRINGS = {
	en: {
		...
		minimap: 'Live route map with upcoming corners',
		originalTrack: 'OG Grid',
		originalTrackMeta: 'Original tiled circuit',
		monacoTrack: 'Monaco GP',
		monacoTrackMeta: 'OG-style tiled street circuit',
		mapAttribution: 'Monaco geometry © OpenStreetMap contributors',
		host: 'Host',
		you: 'You',
		lap: 'LAP',
		best: 'BEST',
	...
	mn: {
		...
		minimap: 'Дараагийн эргэлтүүдийг харуулах замын зураг',
		originalTrack: 'OG зам',
		originalTrackMeta: 'Анхны хавтан зам',
		monacoTrack: 'Монако GP',
		monacoTrackMeta: 'OG загварын хавтан зам',
		mapAttribution: 'Монако зураглал © OpenStreetMap contributors',
		host: 'Эзэн',
		you: 'Та',
		lap: 'ТОЙРОГ',
		best: 'ШИЛДЭГ',
